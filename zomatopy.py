...
class Zomato:
    ...
    def restaurant_search_ordered_by_ratings(self, query="", latitude="", longitude="", cuisines=""):
        """
        Takes either query, latitude and longitude or cuisine as input.
        Returns a list of Restaurant IDs sorted in descending order based on ratings.
        """
        headers = {'Accept': 'application/json', 'user-key': self.user_key}
